...
import { Row, Col, Menu, Dropdown, Breadcrumb } from "antd";
    ...
    <>
      ...
      <div className="site-layout-content">
        <Row>
          ...
          <Col span={12} style={{ padding: 5 }}>
            <center>
              <h1>Force Exertion on Asset (w.r.t Time)</h1>
            </center>
            <br />
            <Dropdown overlay={menu} trigger={["click"]}>
              <h1>
        ...
        <Row>
          <Col span={12} style={{ padding: 5 }}>
            <center>
              <h1>Angle of Tiltation (w.r.t. Time)</h1>
            </center>
            <br />
            <Dropdown overlay={menu} trigger={["click"]}>
              <h1>
            ...
            <br />
            <Line {...tiltation_config} />
            <br />
            <small>Time Updated : {time}</small>
          </Col>
          <Col span={12} style={{ padding: 5 }}>
            <center>
              <h1>Temparature of Asset</h1>
            </center>
            <br />
            <Dropdown overlay={menu} trigger={["click"]}>
              <h1>
