...
function Numbers2() {
    ...
    return (
        <div>
            ...
            <Row className={'overview2'}>
                <Col span={5}>
                    <Card title={'Current RPM'} className="o_cards">
                        <GaugeChart
                            nrOfLevels={30}
                ...
                <Col span={9}>
                    <Card title={'Calculated Engine Load'}>
                        <div style={{ width: '100%', height: 180 }}>
                            <ResponsiveContainer>
                                <LineChart
                                    width={500}
            ...
            <Row className={'overview2'}>
                <Col span={5}>
                    <Card title={'Current KMPH'} className="o_cards">
                        <GaugeChart
                            nrOfLevels={30}
                            percent={tilt_percent}
                            formatTextValue={(tilt_percent) =>
                ...
                <Col span={9}>
                    <Card title={'Fuel Rail Pressure (Direct Inject)'}>
                        <div style={{ width: '100%', height: 180 }}>
